    ...
    <div className="min-h-screen bg-[#0A0A0A] text-[#FAF9F6] font-sans antialiased overflow-x-hidden relative">
      ...
      <nav className={`fixed w-full z-[100] transition-all duration-700 ${
        ...
        <div className="max-w-[1800px] mx-auto px-6 md:px-8 flex justify-between items-center">
          <button onClick={scrollToTop} className="w-24 md:w-36 flex items-center cursor-pointer">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[110] bg-black/98 backdrop-blur-2xl flex flex-col items-center justify-center space-y-10 animate-fade-in">
          ...
          <div className="flex gap-8 pt-4">
            <a href={CONFIG.instagramUrl} target="_blank" rel="noopener noreferrer" className="text-white/40"><Icons.Instagram /></a>
            <a href={CONFIG.yelpUrl} target="_blank" rel="noopener noreferrer" className="text-white/40"><Icons.Yelp /></a>
          </div>
        </div>
      )}
      ...
      <header className="relative h-[100svh] min-h-[600px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1800px] mx-auto px-6 md:px-8 h-full flex items-center lg:items-center items-end pb-20 lg:pb-0">
          <div className="max-w-xl bg-white/[0.01] backdrop-blur-[2px] border-l border-white/10 p-6 md:p-12 relative group">
            ...
            <p className="max-w-sm text-stone-400 text-sm md:text-base font-light leading-relaxed mb-8 border-l border-stone-800/50 pl-6">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 md:gap-20 items-center">
          <div className="lg:col-span-6">
            <div className="overflow-hidden shadow-2xl">
               <img src={ASSETS.interiorReception} alt="Interior" className="w-full aspect-[4/5] object-cover" />
            </div>
          </div>
