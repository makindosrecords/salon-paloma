  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-[#FAF9F6] font-sans antialiased overflow-x-hidden relative">
      ...
      <nav className={`fixed w-full z-[100] transition-all duration-700 ${
        ...
        <div className="max-w-[1800px] mx-auto px-5 md:px-8 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4 md:gap-8">
            {/* SOCIAL LINKS - Now persistent in header for mobile */}
      ...
      {/* HERO SECTION - OPTIMIZED FOR FRAMING AND CLARITY */}
      <header className="relative h-[100svh] min-h-[650px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Subtle overlay for anchoring text without losing image details */}
          <div className="absolute inset-0 bg-black/30 lg:bg-transparent" />
          <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/80 lg:bg-gradient-to-r lg:from-black/80 lg:via-transparent lg:to-transparent" />
        </div>

        <div className="relative z-10 w-full max-w-[1800px] mx-auto px-6 md:px-8 h-full flex items-end pb-12 lg:items-center lg:pb-0">
          <div className="max-w-lg bg-black/10 backdrop-blur-[2px] border-l border-white/20 p-6 md:p-12 relative group">
